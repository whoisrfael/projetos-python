""" Modulo principal com a logica do jogo da forca"""
...
class HangmanGame:
    """ Classe principal que implementa a logica do jogo da forca."""
    ...
    def __init__(self, word_list: Optional[list] = None, word: Optional[str] = None):
        ...
        Args:
            ...
            word: Palavra especifica para o jogo ( para testes ou carregar)"""
    ...
    def _load_word_list(self) -> list:
        """Carrega a lista de palavvras do arquivo configurado"""
        try:
    ...
    def _select_random_word(self) -> str:
        """Seleciona uma palavra aleatoria da lista."""
        if not self.word_list:
            raise ValueError("A lista de palavras nao pode estar vazia.")
    ...
    def get_current_state(self) -> Dict:
        ...
        Returns: 
            Dicionario com o estado do jogo.
        """
        return {
    ...
    def _should_show_hint(self) -> bool:
        ...
        return (GameConfig.SHOW_HINT_AFTER > 0 and
                not self.hint_shown and
                self.incorrect_attempts >= GameConfig.SHOW_HINT_AFTER)
    ...
    def calculate_score(self) -> int:
        """Calcula a pontuacao atual baseada do desempenho."""
        if not self.word:
            return 0
    ...
    def guess_letter(self, letter: str) -> None:
        ...
        Raises:
            GameOverError: Se o jogo ja terminou
            InvalidLetterError: se a letra for invalida
            RepeatedLetterError: Se a letra ja foi tentada."""
        
        if self.game_over:
            raise GameOverError("O jogo ja terminou. Iniciou um novo jogo.")
        ...
        def _end_game(self, winner: bool) -> None:
            """Finaliza o jogo e registra a pontuação se aplicavel."""
            self.game_over = True
            self.winner = winner
            ...
            if self.player_name and self.winner:
                try:
                    ...
                    print(f"Warning: Não foi possivel salvar a pontuação. {str(e)}")
        ...
        def load_game(cls, filename: str) -> 'HangmanGame':
            ...
            Returns:
                Instancia do HangmanGame carregada
            """
